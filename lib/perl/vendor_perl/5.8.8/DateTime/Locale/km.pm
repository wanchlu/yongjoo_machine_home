...
sub long_date_format               { "\%\{day\}\ ខែ\ \%B\ ឆ្នាំ\ \ \%\{ce_year\}" }
sub medium_date_format             { "\%\{day\}\ \%b\ \%\{ce_year\}" }
sub short_date_format              { "\%\{day\}\/\%\{month\}\/\%\{ce_year\}" }
sub full_time_format               { "\%\{hour\}\ ម៉ោង\ \%\{minute\}\ នាទី\ \%S\ វិនាទី​\ v" }
sub long_time_format               { "\%\{hour\}\ ម៉ោង\ \%\{minute\}\ នាទី\ \%S\ វិនាទី​\%\{time_zone_long_name\}" }
