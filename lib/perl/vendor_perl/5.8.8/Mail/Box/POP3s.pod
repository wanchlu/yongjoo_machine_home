...
Mail::Box::POP3s-E<gt>B<listSubFolders>(OPTIONS)

See L<Mail::Box::POP3/"METHODS">

=item $obj-E<gt>B<nameOfSubFolder>(SUBNAME, [PARENTNAME])

Mail::Box::POP3s-E<gt>B<nameOfSubFolder>(SUBNAME, [PARENTNAME])
...
Mail::Box::POP3s-E<gt>B<topFolderWithMessages>
...
Mail::Box::POP3s-E<gt>B<create>(FOLDER, OPTIONS)
...
Mail::Box::POP3s-E<gt>B<timespan2seconds>(TIME)
...
Mail::Box::POP3s-E<gt>B<defaultTrace>([LEVEL]|[LOGLEVEL, TRACELEVEL]|[LEVEL, CALLBACK])
...
Mail::Box::POP3s-E<gt>B<log>([LEVEL [,STRINGS]])

See L<Mail::Reporter/"Error handling">

=item $obj-E<gt>B<logPriority>(LEVEL)

Mail::Box::POP3s-E<gt>B<logPriority>(LEVEL)
...
This module is part of Mail-Box distribution version 2.097,
built on January 26, 2011. Website: F<http://perl.overmeer.net/mailbox/>
