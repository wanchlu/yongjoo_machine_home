...
Returns the value used to indicate a missing (or bad) element for the given data type. See the L<badvalue routine in PDL::Bad|PDL::Bad/badvalue> for more details.

=item orig_badvalue

Returns the original value used to represent bad values for a given type. See the L<orig_badvalue routine in PDL::Bad|PDL::Bad/orig_badvalue> for more details.
