 ...
 * contents of BerkeleyDB.xs. Do not edit this file, edit BerkeleyDB.xs instead.
 *
 *	ANY CHANGES MADE HERE WILL BE LOST! 
 *
 */

#line 1 "BerkeleyDB.xs"
/*
...
#line 2242 "BerkeleyDB.c"

/* INCLUDE:  Including 'constants.xs' from 'BerkeleyDB.xs' */


XS(XS_BerkeleyDB_constant); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB_constant)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
/* INCLUDE: Returning to 'BerkeleyDB.xs' from 'constants.xs' */

#define env_db_version(maj, min, patch) 	db_version(&maj, &min, &patch)

XS(XS_BerkeleyDB_db_version); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB_db_version)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 3)
       croak_xs_usage(cv,  "maj, min, patch");
    {
	int	maj = (int)SvIV(ST(0));
	int	min = (int)SvIV(ST(1));
	int	patch = (int)SvIV(ST(2));
#line 2191 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2374 "BerkeleyDB.c"
	char *	RETVAL;
	dXSTARG;

	RETVAL = env_db_version(maj, min, patch);
	sv_setiv(ST(0), (IV)maj);
	SvSETMAGIC(ST(0));
	sv_setiv(ST(1), (IV)min);
	SvSETMAGIC(ST(1));
...
XS(XS_BerkeleyDB_has_heap); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB_has_heap)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	int	RETVAL;
	dXSTARG;
#line 2200 "BerkeleyDB.xs"
#ifdef AT_LEAST_DB_5_2
        RETVAL = __heap_exist() ;
#else
        RETVAL = 0 ;
#endif
#line 2410 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB_db_value_set); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB_db_value_set)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "value, which");
    {
	int	value = (int)SvIV(ST(0));
	int	which = (int)SvIV(ST(1));

	Perl_croak(aTHX_ "BerkeleyDB::db_value_set: not implemented yet");
    }
    XSRETURN(1);
}


XS(XS_BerkeleyDB__db_remove); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__db_remove)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	SV *	ref = ST(0);
#line 2221 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2451 "BerkeleyDB.c"
	DualType	RETVAL;
#line 2223 "BerkeleyDB.xs"
	{
#if DB_VERSION_MAJOR == 2
...
#line 2491 "BerkeleyDB.c"
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__db_verify); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__db_verify)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	SV *	ref = ST(0);
#line 2267 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2514 "BerkeleyDB.c"
	DualType	RETVAL;
#line 2269 "BerkeleyDB.xs"
	{
#ifndef AT_LEAST_DB_3_1
...
XS(XS_BerkeleyDB__db_rename); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__db_rename)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	SV *	ref = ST(0);
#line 2315 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2579 "BerkeleyDB.c"
	DualType	RETVAL;
#line 2317 "BerkeleyDB.xs"
	{
#ifndef AT_LEAST_DB_3_1
...
XS(XS_BerkeleyDB__Env_create); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_create)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 0 || items > 1)
       croak_xs_usage(cv,  "flags=0");
    {
	u_int32_t	flags;
#line 2366 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2645 "BerkeleyDB.c"
	BerkeleyDB__Env__Raw	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_open); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_open)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 4)
       croak_xs_usage(cv,  "env, db_home=NULL, flags=0, mode=0777");
    {
	BerkeleyDB__Env	env;
	char *	db_home;
	u_int32_t	flags;
	int	mode;
#line 2398 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2699 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;

        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            env = NULL ;
        else if (sv_derived_from(ST(0), "BerkeleyDB::Env")) {
            IV tmp = SvIV(getInnerObject(ST(0))) ;
            env = INT2PTR(BerkeleyDB__Env, tmp);
        }
        else
            croak("env is not of type BerkeleyDB::Env");

	if (items < 2)
	    db_home = NULL;
	else {
	    db_home = (char *)SvPV_nolen(ST(1));
	}
...
XS(XS_BerkeleyDB__Env_cds_enabled); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_cds_enabled)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Env	env;
#line 2413 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2757 "BerkeleyDB.c"
	bool	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 2415 "BerkeleyDB.xs"
	    RETVAL = env->cds_enabled ;
#line 2770 "BerkeleyDB.c"
	ST(0) = boolSV(RETVAL);
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_BerkeleyDB__Env_set_encrypt); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_encrypt)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 3)
       croak_xs_usage(cv,  "env, passwd, flags");
    {
	BerkeleyDB__Env	env;
	const char *	passwd;
	u_int32_t        flags = SvUV(ST(2));
#line 2426 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2794 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
	...
	if (ST(1) == &PL_sv_undef)
        ...
        STRLEN len;
            passwd = (const char *)SvPV(ST(1),len) ;
	    if (len == 0)
		passwd = NULL ;
	};
#line 2428 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4_1
...
XS(XS_BerkeleyDB__Env__db_appinit); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env__db_appinit)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "self, ref, errfile=NULL");
    {
	char *	self = (char *)SvPV_nolen(ST(0));
	SV *	ref = ST(1);
	SV *	errfile;
#line 2447 "BerkeleyDB.xs"
	  dMY_CXT;
#line 2846 "BerkeleyDB.c"
	BerkeleyDB__Env__Raw	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_DB_ENV); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_DB_ENV)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Env	env;
#line 2809 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3230 "BerkeleyDB.c"
	DB_ENV *	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 2811 "BerkeleyDB.xs"
	    if (env->active)
	        RETVAL = env->Env ;
	    else
	        RETVAL = NULL;
#line 3247 "BerkeleyDB.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Env_log_archive); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_log_archive)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "env, flags=0");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	u_int32_t	flags;
	BerkeleyDB__Env	env;
#line 2824 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3271 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__Env_log_set_config); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_log_set_config)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 3)
       croak_xs_usage(cv,  "env, flags=0, onoff=0");
    {
	BerkeleyDB__Env	env;
	u_int32_t	flags;
	int	onoff;
#line 2863 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3341 "BerkeleyDB.c"
	DualType	RETVAL;
...
XS(XS_BerkeleyDB__Env_log_get_config); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_log_get_config)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Env	env;
	u_int32_t        flags = SvUV(ST(1));
	int	onoff;
#line 2881 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3397 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 3416 "BerkeleyDB.c"
	sv_setiv(ST(2), (IV)onoff);
	SvSETMAGIC(ST(2));
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Env__txn_begin); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env__txn_begin)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 3)
       croak_xs_usage(cv,  "env, pid=NULL, flags=0");
    {
	u_int32_t	flags;
	BerkeleyDB__Env	env;
	BerkeleyDB__Txn	pid;
#line 2901 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3443 "BerkeleyDB.c"
	BerkeleyDB__Txn__Raw	RETVAL;
	dXSTARG;
	...
	if (ST(1) == &PL_sv_undef || ST(1) == NULL)
	    pid = NULL ;
	else if (sv_derived_from(ST(1), "BerkeleyDB::Txn")) {
	    IV tmp = SvIV(getInnerObject(ST(1))) ;
	    pid = INT2PTR(BerkeleyDB__Txn, tmp);
	}
	else
	    croak("pid is not of type BerkeleyDB::Txn");
	}
#line 2903 "BerkeleyDB.xs"
	{
	    DB_TXN *txn ;
	    DB_TXN *p_id = NULL ;
...
XS(XS_BerkeleyDB__Env_txn_checkpoint); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_txn_checkpoint)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 3 || items > 4)
       croak_xs_usage(cv,  "env, kbyte, min, flags=0");
    {
	BerkeleyDB__Env	env;
	long	kbyte = (long)SvIV(ST(1));
	long	min = (long)SvIV(ST(2));
	u_int32_t	flags;
#line 2959 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3544 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	RETVAL = env_txn_checkpoint(env, kbyte, min, flags);
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Env_txn_stat); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_txn_stat)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Env	env;
	HV *	RETVAL = NULL ;
#line 2966 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3586 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__Env_printEnv); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_printEnv)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Env	env;
#line 3008 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3652 "BerkeleyDB.c"
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 3010 "BerkeleyDB.xs"
	    ckActive_Environment(env->active) ;
#line 3664 "BerkeleyDB.c"
#line 3012 "BerkeleyDB.xs"
#if 0
	  printf("env             [0x%X]\n", env) ;
	  printf("  ErrPrefix     [%s]\n", env->ErrPrefix
	  ...
	  printf("\n") ;
#endif
#line 3687 "BerkeleyDB.c"
    }
    XSRETURN_EMPTY;
}


XS(XS_BerkeleyDB__Env_errPrefix); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_errPrefix)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "env, prefix");
    {
	BerkeleyDB__Env	env;
	SV *	prefix = ST(1);
#line 3039 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3708 "BerkeleyDB.c"
	SV *	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 3041 "BerkeleyDB.xs"
	    ckActive_Environment(env->active) ;
#line 3721 "BerkeleyDB.c"
#line 3043 "BerkeleyDB.xs"
	  if (env->ErrPrefix) {
...
XS(XS_BerkeleyDB__Env_status); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_status)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Env	env;
#line 3065 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3760 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 3067 "BerkeleyDB.xs"
	    RETVAL =  env->Status ;
#line 3773 "BerkeleyDB.c"
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Env_db_appexit); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_db_appexit)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Env	env;
#line 3077 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3797 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 3080 "BerkeleyDB.xs"
	    ckActive_Environment(env->active) ;
#line 3810 "BerkeleyDB.c"
#line 3082 "BerkeleyDB.xs"
#ifdef STRICT_CLOSE
	    if (env->open_dbs)
...
XS(XS_BerkeleyDB__Env__DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env__DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Env	env;
	int	RETVAL = 0 ;
#line 3103 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3848 "BerkeleyDB.c"
...
#line 3881 "BerkeleyDB.c"
    }
    XSRETURN_EMPTY;
}


XS(XS_BerkeleyDB__Env__TxnMgr); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env__TxnMgr)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Env	env;
#line 3132 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3901 "BerkeleyDB.c"
	BerkeleyDB__TxnMgr__Raw	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 3134 "BerkeleyDB.xs"
	    ckActive_Environment(env->active) ;
	    if (!env->txn_enabled)
		softCrash("Transaction Manager not enabled") ;
#line 3917 "BerkeleyDB.c"
#line 3138 "BerkeleyDB.xs"
	    ZMALLOC(RETVAL, BerkeleyDB_TxnMgr_type) ;
	    RETVAL->env  = env ;
	    /* hash_store_iv("BerkeleyDB::Term::TxnMgr", (char *)txn, 1) ; */
#line 3922 "BerkeleyDB.c"
	XSprePUSH; PUSHi(PTR2IV(RETVAL));
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Env_get_shm_key); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_get_shm_key)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "env, id");
    {
	BerkeleyDB__Env	env;
	long	id;
#line 3149 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3944 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_set_lg_dir); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_lg_dir)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "env, dir");
    {
	BerkeleyDB__Env	env;
	char *	dir = (char *)SvPV_nolen(ST(1));
#line 3168 "BerkeleyDB.xs"
	  dMY_CXT;
#line 3989 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_set_lg_bsize); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_lg_bsize)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "env, bsize");
    {
	BerkeleyDB__Env	env;
	u_int32_t        bsize = SvUV(ST(1));
#line 3185 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4032 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_set_lg_max); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_lg_max)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "env, lg_max");
    {
	BerkeleyDB__Env	env;
	u_int32_t        lg_max = SvUV(ST(1));
#line 3202 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4075 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_set_data_dir); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_data_dir)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Env	env;
	char *	dir = (char *)SvPV_nolen(ST(1));
#line 3219 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4118 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 3221 "BerkeleyDB.xs"
	  ckActive_Database(env->active) ;
#line 4132 "BerkeleyDB.c"
#line 3223 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_3_1
...
XS(XS_BerkeleyDB__Env_set_tmp_dir); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_tmp_dir)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Env	env;
	char *	dir = (char *)SvPV_nolen(ST(1));
#line 3237 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4162 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_set_mutexlocks); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_mutexlocks)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "env, do_lock");
    {
	BerkeleyDB__Env	env;
	int	do_lock = (int)SvIV(ST(1));
#line 3254 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4205 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 3256 "BerkeleyDB.xs"
	  ckActive_Database(env->active) ;
#line 4219 "BerkeleyDB.c"
#line 3258 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_3
...
XS(XS_BerkeleyDB__Env_set_verbose); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_verbose)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 3)
       croak_xs_usage(cv,  "env, which, onoff");
    {
	BerkeleyDB__Env	env;
	u_int32_t        which = SvUV(ST(1));
	int	onoff = (int)SvIV(ST(2));
#line 3280 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4257 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_set_flags); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_flags)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	u_int32_t        flags = SvUV(ST(1));
	int	onoff = (int)SvIV(ST(2));
#line 3298 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4301 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_lsn_reset); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_lsn_reset)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 3)
       croak_xs_usage(cv,  "env, file, flags");
    {
	BerkeleyDB__Env	env;
	char*	file = (char *)SvPV_nolen(ST(1));
	u_int32_t        flags = SvUV(ST(2));
#line 3316 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4345 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_lock_detect); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_lock_detect)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 3)
       croak_xs_usage(cv,  "env, atype=DB_LOCK_DEFAULT, flags=0");
    {
	BerkeleyDB__Env	env;
	u_int32_t	atype;
	u_int32_t	flags;
#line 3334 "BerkeleyDB.xs"
       dMY_CXT;
#line 4389 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
#line 3336 "BerkeleyDB.xs"
       ckActive_Database(env->active) ;
#line 4415 "BerkeleyDB.c"
#line 3338 "BerkeleyDB.xs"
...
XS(XS_BerkeleyDB__Env_set_timeout); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_timeout)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "env, timeout, flags=0");
    {
	BerkeleyDB__Env	env;
	db_timeout_t        timeout = SvUV(ST(1));
	u_int32_t	flags;
#line 3353 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4445 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_get_timeout); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_get_timeout)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	u_int32_t	flags;
#line 3371 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4495 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB__Env_stat_print); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_stat_print)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_BerkeleyDB__Env_lock_stat_print); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_lock_stat_print)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_BerkeleyDB__Env_mutex_stat_print); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_mutex_stat_print)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_BerkeleyDB__Env_txn_stat_print); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_txn_stat_print)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_BerkeleyDB__Env_failchk); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_failchk)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#line 3450 "BerkeleyDB.xs"
	  ckActive_Database(env->active) ;
#line 4748 "BerkeleyDB.c"
#line 3452 "BerkeleyDB.xs"
#if ! defined(AT_LEAST_DB_4_4) || defined(_WIN32)
#ifndef AT_LEAST_DB_4_4
...
XS(XS_BerkeleyDB__Env_set_isalive); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Env_set_isalive)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 3469 "BerkeleyDB.xs"
	  ckActive_Database(env->active) ;
#line 4792 "BerkeleyDB.c"
#line 3471 "BerkeleyDB.xs"
#if ! defined(AT_LEAST_DB_4_4) || defined(_WIN32)
#ifndef AT_LEAST_DB_4_4
...
XS(XS_BerkeleyDB__Term_close_everything); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Term_close_everything)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 3492 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4824 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__Term_safeCroak); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Term_safeCroak)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#line 3499 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4847 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__Hash__db_open_hash); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Hash__db_open_hash)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "self, ref");
    {
	char *	self = (char *)SvPV_nolen(ST(0));
	SV *	ref = ST(1);
#line 3508 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4870 "BerkeleyDB.c"
	BerkeleyDB__Hash__Raw	RETVAL;
	dXSTARG;
#line 3510 "BerkeleyDB.xs"
	{
	    HV *		hash ;
	    SV * 		sv ;
	    DB_INFO 		info ;
...
XS(XS_BerkeleyDB__Hash_db_stat); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Hash_db_stat)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	int	flags;
	BerkeleyDB__Common	db;
	HV *	RETVAL = NULL ;
#line 3573 "BerkeleyDB.xs"
	  dMY_CXT;
#line 4950 "BerkeleyDB.c"
	...
	if (items < 2)
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            db = NULL ;
        else if (sv_derived_from(ST(0), "BerkeleyDB::Common")) {
            IV tmp = SvIV(getInnerObject(ST(0))) ;
            db = INT2PTR(BerkeleyDB__Common, tmp);
        }
        else
            croak("db is not of type BerkeleyDB::Common");
#line 3575 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
#line 4968 "BerkeleyDB.c"
#line 3577 "BerkeleyDB.xs"
	{
#if DB_VERSION_MAJOR == 2
...
XS(XS_BerkeleyDB__Unknown__db_open_unknown); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Unknown__db_open_unknown)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	SV *	ref = ST(0);
#line 3634 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5041 "BerkeleyDB.c"
#line 3636 "BerkeleyDB.xs"
	{
	    HV *		hash ;
	    SV * 		sv ;
	    DB_INFO 		info ;
...
XS(XS_BerkeleyDB__Btree__db_open_btree); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Btree__db_open_btree)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	char *	self = (char *)SvPV_nolen(ST(0));
	SV *	ref = ST(1);
#line 3695 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5114 "BerkeleyDB.c"
	BerkeleyDB__Btree__Raw	RETVAL;
	dXSTARG;
#line 3697 "BerkeleyDB.xs"
	{
	    HV *		hash ;
	    SV * 		sv ;
	    DB_INFO 		info ;
...
XS(XS_BerkeleyDB__Btree_db_stat); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Btree_db_stat)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Common	db;
	HV *	RETVAL = NULL ;
#line 3766 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5200 "BerkeleyDB.c"
	...
	if (items < 2)
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 3768 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
#line 5218 "BerkeleyDB.c"
#line 3770 "BerkeleyDB.xs"
	{
	    DB_BTREE_STAT *	stat ;
#ifdef AT_LEAST_DB_4_3
	    db->Status = ((db->dbp)->stat)(db->dbp, db->txn, &stat, flags) ;
...
XS(XS_BerkeleyDB__Heap__db_open_heap); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Heap__db_open_heap)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	char *	self = (char *)SvPV_nolen(ST(0));
	SV *	ref = ST(1);
#line 3841 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5304 "BerkeleyDB.c"
	BerkeleyDB__Heap__Raw	RETVAL;
	dXSTARG;
#line 3843 "BerkeleyDB.xs"
	{
...
XS(XS_BerkeleyDB__Recno__db_open_recno); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Recno__db_open_recno)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	char *	self = (char *)SvPV_nolen(ST(0));
	SV *	ref = ST(1);
#line 3897 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5372 "BerkeleyDB.c"
	BerkeleyDB__Recno__Raw	RETVAL;
	dXSTARG;
#line 3899 "BerkeleyDB.xs"
	{
	    HV *		hash ;
	    SV * 		sv ;
	    DB_INFO 		info ;
...
XS(XS_BerkeleyDB__Queue__db_open_queue); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Queue__db_open_queue)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	char *	self = (char *)SvPV_nolen(ST(0));
	SV *	ref = ST(1);
#line 3965 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5453 "BerkeleyDB.c"
	BerkeleyDB__Queue__Raw	RETVAL;
	dXSTARG;
#line 3967 "BerkeleyDB.xs"
	{
#ifndef AT_LEAST_DB_3
...
XS(XS_BerkeleyDB__Queue_db_stat); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Queue_db_stat)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Common	db;
	HV *	RETVAL = NULL ;
#line 4032 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5536 "BerkeleyDB.c"
	...
	if (items < 2)
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4034 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
#line 5554 "BerkeleyDB.c"
#line 4036 "BerkeleyDB.xs"
	{
#if DB_VERSION_MAJOR == 2
...
XS(XS_BerkeleyDB__Common_db_close); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_close)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	int	flags;
	BerkeleyDB__Common	db;
#line 4091 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5623 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	if (items < 2)
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4093 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
	    saveCurrentDB(db) ;
#line 5643 "BerkeleyDB.c"
#line 4096 "BerkeleyDB.xs"
...
XS(XS_BerkeleyDB__Common__DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common__DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 4123 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5688 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__Common__db_cursor); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common__db_cursor)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	u_int32_t	flags;
	BerkeleyDB__Common	db;
	BerkeleyDB__Cursor	RETVAL = NULL ;
#line 4141 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5731 "BerkeleyDB.c"
	dXSTARG;
	...
	flags = SvUV(ST(1));
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4144 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
#line 5750 "BerkeleyDB.c"
#line 4146 "BerkeleyDB.xs"
	{
	  DBC *	cursor ;
	  saveCurrentDB(db) ;
...
XS(XS_BerkeleyDB__Common__db_join); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common__db_join)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "db, cursors, flags=0");
    {
	u_int32_t	flags;
	BerkeleyDB__Common	db;
	AV *	cursors;
	BerkeleyDB__Cursor	RETVAL = NULL ;
#line 4207 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5827 "BerkeleyDB.c"
	dXSTARG;
	...
	if (SvROK(ST(1)) && SvTYPE(SvRV(ST(1))) == SVt_PVAV)
        /* if (sv_isa(ST(1), "AVPtr")) */
            cursors = (AV*)SvRV(ST(1));
        else
            croak("cursors is not an array reference");
#line 4209 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
#line 5852 "BerkeleyDB.c"
#line 4211 "BerkeleyDB.xs"
	{
...
XS(XS_BerkeleyDB__Common_ArrayOffset); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_ArrayOffset)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 4283 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5940 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4285 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
#line 5954 "BerkeleyDB.c"
#line 4287 "BerkeleyDB.xs"
#ifdef ALLOW_RECNO_OFFSET
	    RETVAL = db->array_base ? 0 : 1 ;
#else
	    RETVAL = 0 ;
#endif /* ALLOW_RECNO_OFFSET */
#line 5961 "BerkeleyDB.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Common_cds_enabled); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_cds_enabled)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 4300 "BerkeleyDB.xs"
	  dMY_CXT;
#line 5982 "BerkeleyDB.c"
	bool	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4302 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
#line 5995 "BerkeleyDB.c"
#line 4304 "BerkeleyDB.xs"
	    RETVAL = db->cds_enabled ;
#line 5998 "BerkeleyDB.c"
	ST(0) = boolSV(RETVAL);
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_BerkeleyDB__Common_stat_print); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_stat_print)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_BerkeleyDB__Common_type); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_type)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 4329 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6066 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4331 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
#line 6080 "BerkeleyDB.c"
#line 4333 "BerkeleyDB.xs"
	    RETVAL = db->type ;
#line 6083 "BerkeleyDB.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Common_byteswapped); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_byteswapped)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 4341 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6104 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4343 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
#line 6118 "BerkeleyDB.c"
#line 4345 "BerkeleyDB.xs"
#if DB_VERSION_MAJOR == 2 && DB_VERSION_MINOR < 5
...
XS(XS_BerkeleyDB__Common_status); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_status)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 4365 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6154 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4367 "BerkeleyDB.xs"
	    RETVAL =  db->Status ;
#line 6167 "BerkeleyDB.c"
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Common_filter_fetch_key); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_filter_fetch_key)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	SV *	RETVAL = &PL_sv_undef ;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4397 "BerkeleyDB.xs"
	    DBM_setFilter(db->filter_fetch_key, code) ;
#line 6220 "BerkeleyDB.c"
    }
    XSRETURN(1);
}


XS(XS_BerkeleyDB__Common_filter_store_key); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_filter_store_key)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	SV *	RETVAL = &PL_sv_undef ;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4405 "BerkeleyDB.xs"
	    DBM_setFilter(db->filter_store_key, code) ;
#line 6251 "BerkeleyDB.c"
    }
    XSRETURN(1);
}


XS(XS_BerkeleyDB__Common_filter_fetch_value); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_filter_fetch_value)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	SV *	RETVAL = &PL_sv_undef ;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4413 "BerkeleyDB.xs"
	    DBM_setFilter(db->filter_fetch_value, code) ;
#line 6282 "BerkeleyDB.c"
    }
    XSRETURN(1);
}


XS(XS_BerkeleyDB__Common_filter_store_value); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_filter_store_value)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	SV *	RETVAL = &PL_sv_undef ;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4421 "BerkeleyDB.xs"
	    DBM_setFilter(db->filter_store_value, code) ;
#line 6313 "BerkeleyDB.c"
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Common_partial_set); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_partial_set)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 3)
       croak_xs_usage(cv,  "db, offset, length");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	BerkeleyDB__Common	db;
	u_int32_t        offset = SvUV(ST(1));
	u_int32_t        length = SvUV(ST(2));
#line 4431 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6338 "BerkeleyDB.c"
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4433 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
#line 6350 "BerkeleyDB.c"
#line 4435 "BerkeleyDB.xs"
	    if (GIMME == G_ARRAY) {
...
XS(XS_BerkeleyDB__Common_partial_clear); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_partial_clear)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 4449 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6383 "BerkeleyDB.c"
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4451 "BerkeleyDB.xs"
	    ckActive_Database(db->active) ;
#line 6395 "BerkeleyDB.c"
#line 4453 "BerkeleyDB.xs"
	    if (GIMME == G_ARRAY) {
		XPUSHs(sv_2mortal(newSViv(db->partial == DB_DBT_PARTIAL))) ;
		XPUSHs(sv_2mortal(newSViv(db->doff))) ;
		XPUSHs(sv_2mortal(newSViv(db->dlen))) ;
...
XS(XS_BerkeleyDB__Common_db_del); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_del)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Common	db;
	DBTKEY	key;
#line 4471 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6430 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	{
            SvGETMAGIC(ST(1)) ;
                SvUPGRADE(ST(1), SVt_PV); SvOOK_off(ST(1)); SvPOK_only(ST(1));
                /* SvPOK_only(ST(1)); */
                SvGROW(ST(1), DB_HEAP_RID_SZ);
	    DBT_clear(key) ;
	        key.data = SvPVX(ST(1));
	        key.size = DB_HEAP_RID_SZ;
	};
#line 4473 "BerkeleyDB.xs"
	    Trace(("db_del db[%p] in [%p] txn[%p] key[%.*s] flags[%d]\n", db->dbp, db, db->txn, key.size, key.data, flags)) ;
	    ckActive_Database(db->active) ;
	    saveCurrentDB(db) ;
#line 6479 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__Common_db_get); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_get)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 3 || items > 4)
       croak_xs_usage(cv,  "db, key, data, flags=0");
    {
	u_int	flags;
	BerkeleyDB__Common	db;
	DBTKEY_B	key;
	DBT_OPT	data;
#line 4496 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6518 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	if (flagSetBoth()) {
	   ...
	   DBM_ckFilter(my_sv, filter_store_value, "filter_store_value");
           SvGETMAGIC(ST(2)) ;
	   data.data = SvPV(my_sv, len);
	   data.size = (int)len;
  	   data.flags = db->partial ;
    	   data.dlen  = db->dlen ;
	   data.doff  = db->doff ;
	};
#line 4498 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
	  saveCurrentDB(db) ;
	  SetPartial(data,db) ;
	  ...
	  Trace(("  RETVAL %d\n", RETVAL));
#line 6574 "BerkeleyDB.c"
	if (writeToKey()) OutputKey(ST(1), key) ;
	SvSETMAGIC(ST(1));
	OutputValue(ST(2), data)
	SvSETMAGIC(ST(2));
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Common_db_exists); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_exists)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Common	db;
	DBTKEY_B	key;
#line 4517 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6605 "BerkeleyDB.c"
	DualType	RETVAL;
...
XS(XS_BerkeleyDB__Common_db_pget); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_pget)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 4 || items > 5)
       croak_xs_usage(cv,  "db, key, pkey, data, flags=0");
    {
	u_int	flags;
	BerkeleyDB__Common	db;
	DBTKEY_B	key;
	DBTKEY_Bpr	pkey;
	DBT_OPT	data;
#line 4542 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6680 "BerkeleyDB.c"
	DualType	RETVAL;
...

	{
      if(flagSet(DB_GET_BOTH))
      {
	    ...
	    if (db->recno_or_queue || 
	        ...
	        Value = GetRecnoKey(db, SvIV(my_sv)) ; 
	        pkey.data = & Value; 
	        pkey.size = (int)sizeof(db_recno_t);
	    }
	    else {
            STRLEN len;
	        pkey.data = SvPV(my_sv, len);
	        pkey.size = (int)len;
	    }
      }
      else
...
#line 4544 "BerkeleyDB.xs"
	  ...
	  Trace(("  RETVAL %d\n", RETVAL));
#endif
#line 6765 "BerkeleyDB.c"
	if (writeToKey()) OutputKey(ST(1), key) ;
	SvSETMAGIC(ST(1));
	OutputKey_Bpr(ST(2), pkey)
	SvSETMAGIC(ST(2));
	OutputValue(ST(3), data)
	SvSETMAGIC(ST(3));
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Common_db_put); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_put)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	DBTKEY	key;
	DBT	data;
#line 4569 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6799 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 4571 "BerkeleyDB.xs"
	  ...
	  Trace(("  RETVAL %d\n", RETVAL));
#line 6864 "BerkeleyDB.c"
	if (flagSet(DB_APPEND)) OutputKey(ST(1), key) ;
	SvSETMAGIC(ST(1));
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Common_db_key_range); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_key_range)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 5 || items > 6)
       croak_xs_usage(cv,  "db, key, less, equal, greater, flags=0");
    {
	u_int32_t	flags;
	BerkeleyDB__Common	db;
	DBTKEY_B	key;
	...
	double	equal = 0.0 ;
	double	greater = 0.0 ;
#line 4592 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6896 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 6949 "BerkeleyDB.c"
	sv_setnv(ST(2), (double)less);
	SvSETMAGIC(ST(2));
	sv_setnv(ST(3), (double)equal);
	SvSETMAGIC(ST(3));
	sv_setnv(ST(4), (double)greater);
	SvSETMAGIC(ST(4));
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Common_db_fd); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_fd)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 4622 "BerkeleyDB.xs"
	  dMY_CXT;
#line 6979 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4624 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
#line 6993 "BerkeleyDB.c"
#line 4626 "BerkeleyDB.xs"
	  saveCurrentDB(db) ;
	  db_fd(db, RETVAL) ;
#line 6997 "BerkeleyDB.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Common_db_sync); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_sync)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	u_int	flags;
	BerkeleyDB__Common	db;
#line 4638 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7020 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	flags = SvUV(ST(1));
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 4640 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
	  saveCurrentDB(db) ;
#line 7040 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__Common__Txn); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common__Txn)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "db, txn=NULL");
    {
	BerkeleyDB__Common	db;
	BerkeleyDB__Txn	txn;
#line 4648 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7066 "BerkeleyDB.c"
	...
	if (ST(1) == &PL_sv_undef || ST(1) == NULL)
	    ...
	    IV tmp = SvIV(getInnerObject(ST(1))) ;
	    txn = INT2PTR(BerkeleyDB__Txn, tmp);
	}
	else
	    croak("txn is not of type BerkeleyDB::Txn");
	}
#line 4650 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
#line 7091 "BerkeleyDB.c"
#line 4652 "BerkeleyDB.xs"
	   if (txn) {
...
XS(XS_BerkeleyDB__Common_truncate); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_truncate)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "db, countp, flags=0");
    {
	BerkeleyDB__Common	db;
	u_int32_t	countp;
	u_int32_t	flags;
#line 4671 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7126 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 4673 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
#line 7145 "BerkeleyDB.c"
#line 4675 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_3_3
...
#endif
#line 7153 "BerkeleyDB.c"
        sv_setuv(ST(1), (UV)countp);
...
XS(XS_BerkeleyDB__Common_associate); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_associate)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 3 || items > 4)
       croak_xs_usage(cv,  "db, secondary, callback, flags=0");
    {
	BerkeleyDB__Common	db;
	BerkeleyDB__Common	secondary;
	SV*	callback = ST(2);
	u_int32_t	flags;
#line 4699 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7189 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(1) == &PL_sv_undef || ST(1) == NULL)
            secondary = NULL ;
        else if (sv_derived_from(ST(1), "BerkeleyDB::Common")) {
            IV tmp = SvIV(getInnerObject(ST(1))) ;
            secondary = INT2PTR(BerkeleyDB__Common, tmp);
        }
        else
            croak("secondary is not of type BerkeleyDB::Common");
...
#line 4701 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
#line 7217 "BerkeleyDB.c"
#line 4703 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_3_3
...
XS(XS_BerkeleyDB__Common_associate_foreign); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_associate_foreign)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 4)
       croak_xs_usage(cv,  "db, secondary, callback, flags");
    {
	BerkeleyDB__Common	db;
	BerkeleyDB__Common	secondary;
	SV*	callback = ST(2);
	u_int32_t        flags = SvUV(ST(3));
	foreign_cb_type	callback_ptr = NULL;
#line 4730 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7262 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(1) == &PL_sv_undef || ST(1) == NULL)
            ...
            croak("secondary is not of type BerkeleyDB::Common");
#line 4732 "BerkeleyDB.xs"
	  ckActive_Database(db->active) ;
#line 7284 "BerkeleyDB.c"
#line 4734 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4_8
...
XS(XS_BerkeleyDB__Common_compact); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_compact)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 6)
       croak_xs_usage(cv,  "db, start=NULL, stop=NULL, c_data=NULL, flags=0, end=NULL");
    {
#line 4756 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7324 "BerkeleyDB.c"
#line 4758 "BerkeleyDB.xs"
        DBTKEY	    end_key;
#line 7327 "BerkeleyDB.c"
	BerkeleyDB__Common	db;
	SVnull*	start;
	SVnull*	stop;
	SVnull*	c_data;
	...
	if (items < 6)
	    ...
	    if (ST(5) == NULL || ST(5) == &PL_sv_undef)
		end = NULL ;
	    else
		end = ST(5) ;
	}
#line 4767 "BerkeleyDB.xs"
    {
#ifndef AT_LEAST_DB_4_4
...
#line 7436 "BerkeleyDB.c"
	if (RETVAL == 0 && end) OutputValue_B(ST(5), end_key) ;
	SvSETMAGIC(ST(5));
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Cursor__c_dup); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor__c_dup)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Cursor	db;
	BerkeleyDB__Cursor	RETVAL = NULL ;
#line 4829 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7463 "BerkeleyDB.c"
	dXSTARG;
	...
	flags = SvUV(ST(1));
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            db = NULL ;
        else if (sv_derived_from(ST(0), "BerkeleyDB::Cursor")) {
            IV tmp = SvIV(getInnerObject(ST(0))) ;
            db = INT2PTR(BerkeleyDB__Cursor, tmp);
        }
        else
            croak("db is not of type BerkeleyDB::Cursor");
#line 4831 "BerkeleyDB.xs"
	    saveCurrentDB(db->parent_db);
	    ckActive_Database(db->active) ;
#line 7483 "BerkeleyDB.c"
#line 4834 "BerkeleyDB.xs"
	{
#ifndef AT_LEAST_DB_3
...
XS(XS_BerkeleyDB__Cursor__c_close); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor__c_close)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Cursor	db;
#line 4887 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7552 "BerkeleyDB.c"
	DualType	RETVAL;
...
XS(XS_BerkeleyDB__Cursor__DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor__DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Cursor	db;
#line 4905 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7597 "BerkeleyDB.c"
...
#line 7618 "BerkeleyDB.c"
    }
    XSRETURN_EMPTY;
}


XS(XS_BerkeleyDB__Cursor_status); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor_status)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Cursor	db;
#line 4922 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7638 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Cursor");
#line 4924 "BerkeleyDB.xs"
	    RETVAL =  db->Status ;
#line 7651 "BerkeleyDB.c"
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Cursor_c_del); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor_c_del)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	int	flags;
	BerkeleyDB__Cursor	db;
#line 4935 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7676 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	if (items < 2)
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Cursor");
#line 4937 "BerkeleyDB.xs"
	  saveCurrentDB(db->parent_db);
	  ckActive_Cursor(db->active) ;
#line 7696 "BerkeleyDB.c"

	RETVAL = cu_c_del(db, flags);
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Cursor_c_get); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor_c_get)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	DBTKEY_B	key;
	DBT_B	data;
#line 4951 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7725 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 4953 "BerkeleyDB.xs"
	  ...
	  SetPartial(data,db) ;
	  Trace(("c_get end\n")) ;
#line 7782 "BerkeleyDB.c"

	RETVAL = cu_c_get(db, key, data, flags);
	OutputKey_B(ST(1), key)
	SvSETMAGIC(ST(1));
	if (! flagSet(DB_JOIN_ITEM)) OutputValue_B(ST(2), data) ;
	SvSETMAGIC(ST(2));
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Cursor_c_pget); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor_c_pget)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	DBTKEY_Bpr	pkey;
	DBT_B	data;
#line 4974 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7816 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 4976 "BerkeleyDB.xs"
	  ...
	  Trace(("c_pget end\n")) ;
#endif
#line 7901 "BerkeleyDB.c"
	if (writeToKey()) OutputKey(ST(1), key) ;
	SvSETMAGIC(ST(1));
	OutputKey_Bpr(ST(2), pkey)
	SvSETMAGIC(ST(2));
	OutputValue_B(ST(3), data)
...
XS(XS_BerkeleyDB__Cursor_c_put); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor_c_put)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	DBTKEY	key;
	DBT	data;
#line 5002 "BerkeleyDB.xs"
	  dMY_CXT;
#line 7935 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 5004 "BerkeleyDB.xs"
	  saveCurrentDB(db->parent_db);
	  ckActive_Cursor(db->active) ;
	  /* SetPartial(data,db) ; */
#line 7997 "BerkeleyDB.c"

	RETVAL = cu_c_put(db, key, data, flags);
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Cursor_c_count); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Cursor_c_count)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "db, count, flags=0");
    {
	int	flags;
	BerkeleyDB__Cursor	db;
	u_int32_t	count;
#line 5017 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8025 "BerkeleyDB.c"
	DualType	RETVAL;
...
XS(XS_BerkeleyDB__TxnMgr__txn_begin); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__TxnMgr__txn_begin)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 3)
       croak_xs_usage(cv,  "txnmgr, pid=NULL, flags=0");
    {
	u_int32_t	flags;
	BerkeleyDB__TxnMgr	txnmgr;
	BerkeleyDB__Txn	pid;
#line 5040 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8080 "BerkeleyDB.c"
	BerkeleyDB__Txn__Raw	RETVAL;
	dXSTARG;
	...
	flags = SvUV(ST(2));
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            txnmgr = NULL ;
        else if (sv_derived_from(ST(0), "BerkeleyDB::TxnMgr")) {
            IV tmp = SvIV(getInnerObject(ST(0))) ;
            txnmgr = INT2PTR(BerkeleyDB__TxnMgr, tmp);
        }
        else
            croak("txnmgr is not of type BerkeleyDB::TxnMgr");
...
XS(XS_BerkeleyDB__TxnMgr_status); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__TxnMgr_status)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 1)
       croak_xs_usage(cv,  "mgr");
    {
	BerkeleyDB__TxnMgr	mgr;
#line 5079 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8162 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            IV tmp = SvIV(getInnerObject(ST(0))) ;
            mgr = INT2PTR(BerkeleyDB__TxnMgr, tmp);
        }
        else
            croak("mgr is not of type BerkeleyDB::TxnMgr");
#line 5081 "BerkeleyDB.xs"
	    RETVAL =  mgr->env->TxnMgrStatus ;
#line 8175 "BerkeleyDB.c"
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__TxnMgr__DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__TxnMgr__DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__TxnMgr	mgr;
#line 5090 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8198 "BerkeleyDB.c"
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("mgr is not of type BerkeleyDB::TxnMgr");
#line 5092 "BerkeleyDB.xs"
	  Trace(("In BerkeleyDB::TxnMgr::DESTROY dirty=%d\n", PL_dirty)) ;
          Safefree(mgr) ;
	  Trace(("End of BerkeleyDB::TxnMgr::DESTROY\n")) ;
#line 8212 "BerkeleyDB.c"
    }
    XSRETURN_EMPTY;
}


XS(XS_BerkeleyDB__TxnMgr_txn_close); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__TxnMgr_txn_close)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 1)
       croak_xs_usage(cv,  "txnp");
    {
	BerkeleyDB__TxnMgr	txnp;

	Perl_croak(aTHX_ "BerkeleyDB::TxnMgr::txn_close: not implemented yet");
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__TxnMgr_txn_checkpoint); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__TxnMgr_txn_checkpoint)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 3 || items > 4)
       croak_xs_usage(cv,  "txnp, kbyte, min, flags=0");
    {
	BerkeleyDB__TxnMgr	txnp;
	long	kbyte = (long)SvIV(ST(1));
	long	min = (long)SvIV(ST(2));
	u_int32_t	flags;
#line 5122 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8267 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            IV tmp = SvIV(getInnerObject(ST(0))) ;
            txnp = INT2PTR(BerkeleyDB__TxnMgr, tmp);
        }
        else
            croak("txnp is not of type BerkeleyDB::TxnMgr");
	...
	RETVAL = xx_txn_checkpoint(txnp, kbyte, min, flags);
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__TxnMgr_txn_stat); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__TxnMgr_txn_stat)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__TxnMgr	txnp;
	HV *	RETVAL = NULL ;
#line 5129 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8309 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__TxnMgr_txn_open); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__TxnMgr_txn_open)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 4)
       croak_xs_usage(cv,  "dir, flags, mode, dbenv");
    {
	...
	Perl_croak(aTHX_ "BerkeleyDB::TxnMgr::txn_open: not implemented yet");
    }
    XSRETURN(1);
}


XS(XS_BerkeleyDB__Txn_status); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn_status)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Txn	tid;
#line 5182 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8396 "BerkeleyDB.c"
	DualType	RETVAL;

        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            tid = NULL ;
        else if (sv_derived_from(ST(0), "BerkeleyDB::Txn")) {
            IV tmp = SvIV(getInnerObject(ST(0))) ;
            tid = INT2PTR(BerkeleyDB__Txn, tmp);
        }
        else
            croak("tid is not of type BerkeleyDB::Txn");
#line 5184 "BerkeleyDB.xs"
	    RETVAL =  tid->Status ;
#line 8409 "BerkeleyDB.c"
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Txn_set_timeout); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn_set_timeout)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "txn, timeout, flags=0");
    {
	BerkeleyDB__Txn	txn;
	db_timeout_t        timeout = SvUV(ST(1));
	u_int32_t	flags;
#line 5194 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8434 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
#line 5196 "BerkeleyDB.xs"
	    ckActive_Transaction(txn->active) ;
#line 8454 "BerkeleyDB.c"
#line 5198 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4
	    softCrash("$env->set_timeout needs Berkeley DB 4.x or better") ;
#else
	    RETVAL = txn->Status = txn->txn->set_timeout(txn->txn, timeout, flags);
#endif
#line 8461 "BerkeleyDB.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Txn_set_tx_max); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn_set_tx_max)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "env, max");
    {
	BerkeleyDB__Env	env;
	u_int32_t        max = SvUV(ST(1));
#line 5211 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8483 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 5213 "BerkeleyDB.xs"
	    ckActive_Database(env->active) ;
#line 8497 "BerkeleyDB.c"
#line 5215 "BerkeleyDB.xs"
...
XS(XS_BerkeleyDB__Txn_get_tx_max); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn_get_tx_max)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Env	env;
	u_int32_t	max;
#line 5229 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8527 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("env is not of type BerkeleyDB::Env");
#line 5231 "BerkeleyDB.xs"
	    ckActive_Database(env->active) ;
#line 8541 "BerkeleyDB.c"
#line 5233 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_2_3
	    softCrash("$env->get_tx_max needs Berkeley DB 2_3.x or better") ;
#else
	    RETVAL = env->Status = env->Env->get_tx_max(env->Env, &max);
#endif
#line 8548 "BerkeleyDB.c"
        sv_setuv(ST(1), (UV)max);
...
XS(XS_BerkeleyDB__Txn__DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn__DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Txn	tid;
#line 5246 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8572 "BerkeleyDB.c"
...
XS(XS_BerkeleyDB__Txn_txn_unlink); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn_txn_unlink)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 3)
       croak_xs_usage(cv,  "dir, force, dbenv");
    {
	const char *	dir;
	int	force = (int)SvIV(ST(1));
	BerkeleyDB__Env	dbenv;

	Perl_croak(aTHX_ "BerkeleyDB::Txn::txn_unlink: not implemented yet");
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Txn_txn_prepare); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn_txn_prepare)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Txn	tid;
#line 5280 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8644 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("tid is not of type BerkeleyDB::Txn");
#line 5282 "BerkeleyDB.xs"
	    ckActive_Transaction(tid->active) ;
#line 8657 "BerkeleyDB.c"

	RETVAL = xx_txn_prepare(tid);
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Txn__txn_commit); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn__txn_commit)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "tid, flags=0");
    {
	u_int32_t	flags;
	BerkeleyDB__Txn	tid;
#line 5298 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8692 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	flags = SvUV(ST(1));
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("tid is not of type BerkeleyDB::Txn");
#line 5300 "BerkeleyDB.xs"
	    ckActive_Transaction(tid->active) ;
	    hash_delete("BerkeleyDB::Term::Txn", (char *)tid) ;
	    tid->active = FALSE ;
#line 8713 "BerkeleyDB.c"

	RETVAL = _txn_commit(tid, flags);
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Txn__txn_abort); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn__txn_abort)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Txn	tid;
#line 5313 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8743 "BerkeleyDB.c"
	DualType	RETVAL;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("tid is not of type BerkeleyDB::Txn");
#line 5315 "BerkeleyDB.xs"
	    ckActive_Transaction(tid->active) ;
	    hash_delete("BerkeleyDB::Term::Txn", (char *)tid) ;
	    tid->active = FALSE ;
#line 8758 "BerkeleyDB.c"

	RETVAL = _txn_abort(tid);
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Txn__txn_discard); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn__txn_discard)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Txn	tid;
	u_int32_t	flags;
#line 5333 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8793 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 5335 "BerkeleyDB.xs"
	    ckActive_Transaction(tid->active) ;
	    hash_delete("BerkeleyDB::Term::Txn", (char *)tid) ;
	    tid->active = FALSE ;
#line 8814 "BerkeleyDB.c"

	RETVAL = _txn_discard(tid, flags);
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Txn_txn_id); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Txn_txn_id)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Txn	tid;
#line 5348 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8844 "BerkeleyDB.c"
	u_int32_t	RETVAL;
	dXSTARG;
...
XS(XS_BerkeleyDB___tiedHash_FIRSTKEY); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB___tiedHash_FIRSTKEY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 5356 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8878 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
#line 8924 "BerkeleyDB.c"
    }
    XSRETURN(1);
}


XS(XS_BerkeleyDB___tiedHash_NEXTKEY); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB___tiedHash_NEXTKEY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Common	db;
	DBTKEY	key;
#line 5399 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8945 "BerkeleyDB.c"
	int	RETVAL;
	dXSTARG;
...
#line 8976 "BerkeleyDB.c"
    }
    XSRETURN(1);
}


XS(XS_BerkeleyDB__Recno_FETCHSIZE); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Recno_FETCHSIZE)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 5426 "BerkeleyDB.xs"
	  dMY_CXT;
#line 8996 "BerkeleyDB.c"
	I32	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 5428 "BerkeleyDB.xs"
            saveCurrentDB(db) ;
            RETVAL = GetArrayLength(db) ;
#line 9011 "BerkeleyDB.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Queue_FETCHSIZE); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Queue_FETCHSIZE)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	BerkeleyDB__Common	db;
#line 5439 "BerkeleyDB.xs"
	  dMY_CXT;
#line 9032 "BerkeleyDB.c"
	I32	RETVAL;
	dXSTARG;
        ...
        if (ST(0) == &PL_sv_undef || ST(0) == NULL)
            ...
            croak("db is not of type BerkeleyDB::Common");
#line 5441 "BerkeleyDB.xs"
            saveCurrentDB(db) ;
            RETVAL = GetQueueLength(db) ;
#line 9047 "BerkeleyDB.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_BerkeleyDB__Common_db_create_sequence); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Common_db_create_sequence)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Common	db;
	u_int32_t	flags;
#line 5454 "BerkeleyDB.xs"
      dMY_CXT;
#line 9069 "BerkeleyDB.c"
	BerkeleyDB__Sequence	RETVAL;
...
#line 9104 "BerkeleyDB.c"
	ST(0) = sv_newmortal();
        sv_setref_pv(ST(0), "BerkeleyDB::Sequence", (void*)RETVAL);
...
XS(XS_BerkeleyDB__Sequence_open); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_open)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "seq, key, flags=0");
    {
	BerkeleyDB__Sequence	seq;
	DBTKEY_seq	key;
	u_int32_t	flags;
#line 5485 "BerkeleyDB.xs"
        dMY_CXT;
#line 9129 "BerkeleyDB.c"
	DualType	RETVAL;

	if (ST(0) == &PL_sv_undef)
	    seq = NULL ;
        else if (sv_derived_from(ST(0), "BerkeleyDB::Sequence")) {
            IV tmp = SvIV((SV*)SvRV(ST(0)));
            seq = INT2PTR(BerkeleyDB__Sequence, tmp);
        }
        else
            croak("seq is not of type BerkeleyDB::Sequence");

    InputKey_seq(ST(1), key);
...
#line 5487 "BerkeleyDB.xs"
        ckActive_Sequence(seq->active) ;
#line 9150 "BerkeleyDB.c"
#line 5489 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4_3
	    softCrash("$seq->create_sequence needs Berkeley DB 4.3.x or better") ;
#else
        RETVAL = seq->seq->open(seq->seq, seq->db->txn, &key, flags);
#endif
#line 9157 "BerkeleyDB.c"
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Sequence_close); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_close)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "seq, flags=0");
    {
	BerkeleyDB__Sequence	seq;
	u_int32_t	flags;
#line 5502 "BerkeleyDB.xs"
        dMY_CXT;
#line 9181 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 5504 "BerkeleyDB.xs"
        ckActive_Sequence(seq->active) ;
#line 9200 "BerkeleyDB.c"
#line 5506 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4_3
...
XS(XS_BerkeleyDB__Sequence_remove); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_remove)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Sequence	seq;
	u_int32_t	flags;
#line 5524 "BerkeleyDB.xs"
        dMY_CXT;
#line 9236 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 5526 "BerkeleyDB.xs"
        ckActive_Sequence(seq->active) ;
#line 9255 "BerkeleyDB.c"
#line 5528 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4_3
...
XS(XS_BerkeleyDB__Sequence_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 1)
       croak_xs_usage(cv,  "seq");
    {
	BerkeleyDB__Sequence	seq;
#line 5543 "BerkeleyDB.xs"
        dMY_CXT;
#line 9288 "BerkeleyDB.c"
	...
	if (ST(0) == &PL_sv_undef)
	    seq = NULL ;
            ...
            croak("seq is not of type BerkeleyDB::Sequence");
#line 5545 "BerkeleyDB.xs"
#ifdef AT_LEAST_DB_4_3
        if (seq->active)
            (seq->seq->close)(seq->seq, 0);
        Safefree(seq);
#endif
#line 9304 "BerkeleyDB.c"
    }
    XSRETURN_EMPTY;
}


XS(XS_BerkeleyDB__Sequence_get); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_get)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 4)
       croak_xs_usage(cv,  "seq, element, delta=1, flags=0");
    {
	BerkeleyDB__Sequence	seq;
	IV	delta;
	db_seq_t	element;
	u_int32_t	flags;
#line 5558 "BerkeleyDB.xs"
        dMY_CXT;
#line 9327 "BerkeleyDB.c"
	DualType	RETVAL;
...
#line 5560 "BerkeleyDB.xs"
        ckActive_Sequence(seq->active) ;
#line 9352 "BerkeleyDB.c"
#line 5562 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4_3
	    softCrash("$seq->get needs Berkeley DB 4.3.x or better") ;
#else
        RETVAL = seq->seq->get(seq->seq, seq->db->txn, delta, &element, flags);
#endif
#line 9359 "BerkeleyDB.c"
        sv_setpvn((SV*)ST(1), (char*)&element, sizeof(db_seq_t));
...
XS(XS_BerkeleyDB__Sequence_get_key); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_get_key)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "seq, key");
    {
	BerkeleyDB__Sequence	seq;
	DBTKEY_seq	key;
#line 5576 "BerkeleyDB.xs"
        dMY_CXT;
#line 9386 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	if (ST(0) == &PL_sv_undef)
	    seq = NULL ;
            ...
            croak("seq is not of type BerkeleyDB::Sequence");
#line 5578 "BerkeleyDB.xs"
        ckActive_Sequence(seq->active) ;
#line 9399 "BerkeleyDB.c"
#line 5580 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4_3
...
#endif
#line 9407 "BerkeleyDB.c"
	OutputKey_seq(ST(1), key)
	SvSETMAGIC(ST(1));
	ST(0) = sv_newmortal();
	setDUALerrno(ST(0), RETVAL) ;
...
XS(XS_BerkeleyDB__Sequence_initial_value); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_initial_value)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "seq, low, high=0");
    {
	BerkeleyDB__Sequence	seq;
	int	low = (int)SvIV(ST(1));
	int	high;
#line 5596 "BerkeleyDB.xs"
        dMY_CXT;
#line 9434 "BerkeleyDB.c"
	DualType	RETVAL;
...
XS(XS_BerkeleyDB__Sequence_set_cachesize); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_set_cachesize)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "seq, size");
    {
	BerkeleyDB__Sequence	seq;
	int32_t        size = SvUV(ST(1));
#line 5613 "BerkeleyDB.xs"
        dMY_CXT;
#line 9484 "BerkeleyDB.c"
	DualType	RETVAL;
...
XS(XS_BerkeleyDB__Sequence_get_cachesize); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_get_cachesize)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Sequence	seq;
	int32_t	size;
#line 5630 "BerkeleyDB.xs"
        dMY_CXT;
#line 9528 "BerkeleyDB.c"
	DualType	RETVAL;
	...
	if (ST(0) == &PL_sv_undef)
	    seq = NULL ;
            ...
            croak("seq is not of type BerkeleyDB::Sequence");
#line 5632 "BerkeleyDB.xs"
        ckActive_Sequence(seq->active) ;
#line 9541 "BerkeleyDB.c"
#line 5634 "BerkeleyDB.xs"
#ifndef AT_LEAST_DB_4_3
	    softCrash("$seq->get_cachesize needs Berkeley DB 4.3.x or better") ;
#else
        RETVAL = seq->seq->get_cachesize(seq->seq, &size);
#endif
#line 9548 "BerkeleyDB.c"
        sv_setuv(ST(1), (UV)size);
...
XS(XS_BerkeleyDB__Sequence_set_flags); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_set_flags)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       croak_xs_usage(cv,  "seq, flags");
    {
	BerkeleyDB__Sequence	seq;
	u_int32_t        flags = SvUV(ST(1));
#line 5648 "BerkeleyDB.xs"
        dMY_CXT;
#line 9575 "BerkeleyDB.c"
	DualType	RETVAL;
...
XS(XS_BerkeleyDB__Sequence_get_flags); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_get_flags)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	BerkeleyDB__Sequence	seq;
	u_int32_t	flags;
#line 5665 "BerkeleyDB.xs"
        dMY_CXT;
#line 9619 "BerkeleyDB.c"
	DualType	RETVAL;
...
XS(XS_BerkeleyDB__Sequence_set_range); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_set_range)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	Perl_croak(aTHX_ "BerkeleyDB::Sequence::set_range: not implemented yet");
    }
    XSRETURN(1);
}


XS(XS_BerkeleyDB__Sequence_stat); /* prototype to pass -Wmissing-prototypes */
XS(XS_BerkeleyDB__Sequence_stat)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	Perl_croak(aTHX_ "BerkeleyDB::Sequence::stat: not implemented yet");
    }
    XSRETURN(1);
}
...
extern "C"
#endif
XS(boot_BerkeleyDB); /* prototype to pass -Wmissing-prototypes */
XS(boot_BerkeleyDB)
{
#ifdef dVAR
    dVAR; dXSARGS;
...

    {
        ...
        newXS("BerkeleyDB::constant", XS_BerkeleyDB_constant, file);
        newXS("BerkeleyDB::db_version", XS_BerkeleyDB_db_version, file);
        newXS("BerkeleyDB::has_heap", XS_BerkeleyDB_has_heap, file);
        newXS("BerkeleyDB::db_value_set", XS_BerkeleyDB_db_value_set, file);
        newXS("BerkeleyDB::_db_remove", XS_BerkeleyDB__db_remove, file);
        newXS("BerkeleyDB::_db_verify", XS_BerkeleyDB__db_verify, file);
        newXS("BerkeleyDB::_db_rename", XS_BerkeleyDB__db_rename, file);
        newXS("BerkeleyDB::Env::create", XS_BerkeleyDB__Env_create, file);
        newXS("BerkeleyDB::Env::open", XS_BerkeleyDB__Env_open, file);
        newXS("BerkeleyDB::Env::cds_enabled", XS_BerkeleyDB__Env_cds_enabled, file);
        newXS("BerkeleyDB::Env::set_encrypt", XS_BerkeleyDB__Env_set_encrypt, file);
        newXS("BerkeleyDB::Env::_db_appinit", XS_BerkeleyDB__Env__db_appinit, file);
        newXS("BerkeleyDB::Env::DB_ENV", XS_BerkeleyDB__Env_DB_ENV, file);
        newXS("BerkeleyDB::Env::log_archive", XS_BerkeleyDB__Env_log_archive, file);
        newXS("BerkeleyDB::Env::log_set_config", XS_BerkeleyDB__Env_log_set_config, file);
        newXS("BerkeleyDB::Env::log_get_config", XS_BerkeleyDB__Env_log_get_config, file);
        newXS("BerkeleyDB::Env::_txn_begin", XS_BerkeleyDB__Env__txn_begin, file);
        newXS("BerkeleyDB::Env::txn_checkpoint", XS_BerkeleyDB__Env_txn_checkpoint, file);
        newXS("BerkeleyDB::Env::txn_stat", XS_BerkeleyDB__Env_txn_stat, file);
        newXS("BerkeleyDB::Env::printEnv", XS_BerkeleyDB__Env_printEnv, file);
        newXS("BerkeleyDB::Env::errPrefix", XS_BerkeleyDB__Env_errPrefix, file);
        newXS("BerkeleyDB::Env::status", XS_BerkeleyDB__Env_status, file);
        cv = newXS("BerkeleyDB::Env::db_appexit", XS_BerkeleyDB__Env_db_appexit, file);
        XSANY.any_i32 = 0 ;
        cv = newXS("BerkeleyDB::Env::close", XS_BerkeleyDB__Env_db_appexit, file);
        XSANY.any_i32 = 1 ;
        newXS("BerkeleyDB::Env::_DESTROY", XS_BerkeleyDB__Env__DESTROY, file);
        newXS("BerkeleyDB::Env::_TxnMgr", XS_BerkeleyDB__Env__TxnMgr, file);
        newXS("BerkeleyDB::Env::get_shm_key", XS_BerkeleyDB__Env_get_shm_key, file);
        newXS("BerkeleyDB::Env::set_lg_dir", XS_BerkeleyDB__Env_set_lg_dir, file);
        newXS("BerkeleyDB::Env::set_lg_bsize", XS_BerkeleyDB__Env_set_lg_bsize, file);
        newXS("BerkeleyDB::Env::set_lg_max", XS_BerkeleyDB__Env_set_lg_max, file);
        newXS("BerkeleyDB::Env::set_data_dir", XS_BerkeleyDB__Env_set_data_dir, file);
        newXS("BerkeleyDB::Env::set_tmp_dir", XS_BerkeleyDB__Env_set_tmp_dir, file);
        newXS("BerkeleyDB::Env::set_mutexlocks", XS_BerkeleyDB__Env_set_mutexlocks, file);
        newXS("BerkeleyDB::Env::set_verbose", XS_BerkeleyDB__Env_set_verbose, file);
        newXS("BerkeleyDB::Env::set_flags", XS_BerkeleyDB__Env_set_flags, file);
        newXS("BerkeleyDB::Env::lsn_reset", XS_BerkeleyDB__Env_lsn_reset, file);
        newXS("BerkeleyDB::Env::lock_detect", XS_BerkeleyDB__Env_lock_detect, file);
        newXS("BerkeleyDB::Env::set_timeout", XS_BerkeleyDB__Env_set_timeout, file);
        newXS("BerkeleyDB::Env::get_timeout", XS_BerkeleyDB__Env_get_timeout, file);
        newXS("BerkeleyDB::Env::stat_print", XS_BerkeleyDB__Env_stat_print, file);
        newXS("BerkeleyDB::Env::lock_stat_print", XS_BerkeleyDB__Env_lock_stat_print, file);
        newXS("BerkeleyDB::Env::mutex_stat_print", XS_BerkeleyDB__Env_mutex_stat_print, file);
        newXS("BerkeleyDB::Env::txn_stat_print", XS_BerkeleyDB__Env_txn_stat_print, file);
        newXS("BerkeleyDB::Env::failchk", XS_BerkeleyDB__Env_failchk, file);
        newXS("BerkeleyDB::Env::set_isalive", XS_BerkeleyDB__Env_set_isalive, file);
        newXS("BerkeleyDB::Term::close_everything", XS_BerkeleyDB__Term_close_everything, file);
        newXS("BerkeleyDB::Term::safeCroak", XS_BerkeleyDB__Term_safeCroak, file);
        newXS("BerkeleyDB::Hash::_db_open_hash", XS_BerkeleyDB__Hash__db_open_hash, file);
        newXS("BerkeleyDB::Hash::db_stat", XS_BerkeleyDB__Hash_db_stat, file);
        newXS("BerkeleyDB::Unknown::_db_open_unknown", XS_BerkeleyDB__Unknown__db_open_unknown, file);
        newXS("BerkeleyDB::Btree::_db_open_btree", XS_BerkeleyDB__Btree__db_open_btree, file);
        newXS("BerkeleyDB::Btree::db_stat", XS_BerkeleyDB__Btree_db_stat, file);
        newXS("BerkeleyDB::Heap::_db_open_heap", XS_BerkeleyDB__Heap__db_open_heap, file);
        newXS("BerkeleyDB::Recno::_db_open_recno", XS_BerkeleyDB__Recno__db_open_recno, file);
        newXS("BerkeleyDB::Queue::_db_open_queue", XS_BerkeleyDB__Queue__db_open_queue, file);
        newXS("BerkeleyDB::Queue::db_stat", XS_BerkeleyDB__Queue_db_stat, file);
        newXS("BerkeleyDB::Common::db_close", XS_BerkeleyDB__Common_db_close, file);
        newXS("BerkeleyDB::Common::_DESTROY", XS_BerkeleyDB__Common__DESTROY, file);
        cv = newXS("BerkeleyDB::Common::__db_write_cursor", XS_BerkeleyDB__Common__db_cursor, file);
        XSANY.any_i32 = 1 ;
        cv = newXS("BerkeleyDB::Common::_db_cursor", XS_BerkeleyDB__Common__db_cursor, file);
        XSANY.any_i32 = 0 ;
        newXS("BerkeleyDB::Common::_db_join", XS_BerkeleyDB__Common__db_join, file);
        newXS("BerkeleyDB::Common::ArrayOffset", XS_BerkeleyDB__Common_ArrayOffset, file);
        newXS("BerkeleyDB::Common::cds_enabled", XS_BerkeleyDB__Common_cds_enabled, file);
        newXS("BerkeleyDB::Common::stat_print", XS_BerkeleyDB__Common_stat_print, file);
        newXS("BerkeleyDB::Common::type", XS_BerkeleyDB__Common_type, file);
        newXS("BerkeleyDB::Common::byteswapped", XS_BerkeleyDB__Common_byteswapped, file);
        newXS("BerkeleyDB::Common::status", XS_BerkeleyDB__Common_status, file);
#if XSubPPtmpAAAA
        newXS("BerkeleyDB::Common::filter_fetch_key", XS_BerkeleyDB__Common_filter_fetch_key, file);
        newXS("BerkeleyDB::Common::filter_store_key", XS_BerkeleyDB__Common_filter_store_key, file);
        newXS("BerkeleyDB::Common::filter_fetch_value", XS_BerkeleyDB__Common_filter_fetch_value, file);
        newXS("BerkeleyDB::Common::filter_store_value", XS_BerkeleyDB__Common_filter_store_value, file);
#endif
        newXS("BerkeleyDB::Common::partial_set", XS_BerkeleyDB__Common_partial_set, file);
        newXS("BerkeleyDB::Common::partial_clear", XS_BerkeleyDB__Common_partial_clear, file);
        newXS("BerkeleyDB::Common::db_del", XS_BerkeleyDB__Common_db_del, file);
        newXS("BerkeleyDB::Common::db_get", XS_BerkeleyDB__Common_db_get, file);
        newXS("BerkeleyDB::Common::db_exists", XS_BerkeleyDB__Common_db_exists, file);
        newXS("BerkeleyDB::Common::db_pget", XS_BerkeleyDB__Common_db_pget, file);
        newXS("BerkeleyDB::Common::db_put", XS_BerkeleyDB__Common_db_put, file);
        newXS("BerkeleyDB::Common::db_key_range", XS_BerkeleyDB__Common_db_key_range, file);
        newXS("BerkeleyDB::Common::db_fd", XS_BerkeleyDB__Common_db_fd, file);
        newXS("BerkeleyDB::Common::db_sync", XS_BerkeleyDB__Common_db_sync, file);
        newXS("BerkeleyDB::Common::_Txn", XS_BerkeleyDB__Common__Txn, file);
        newXS("BerkeleyDB::Common::truncate", XS_BerkeleyDB__Common_truncate, file);
        newXS("BerkeleyDB::Common::associate", XS_BerkeleyDB__Common_associate, file);
        newXS("BerkeleyDB::Common::associate_foreign", XS_BerkeleyDB__Common_associate_foreign, file);
        newXS("BerkeleyDB::Common::compact", XS_BerkeleyDB__Common_compact, file);
        newXS("BerkeleyDB::Cursor::_c_dup", XS_BerkeleyDB__Cursor__c_dup, file);
        newXS("BerkeleyDB::Cursor::_c_close", XS_BerkeleyDB__Cursor__c_close, file);
        newXS("BerkeleyDB::Cursor::_DESTROY", XS_BerkeleyDB__Cursor__DESTROY, file);
        newXS("BerkeleyDB::Cursor::status", XS_BerkeleyDB__Cursor_status, file);
        newXS("BerkeleyDB::Cursor::c_del", XS_BerkeleyDB__Cursor_c_del, file);
        newXS("BerkeleyDB::Cursor::c_get", XS_BerkeleyDB__Cursor_c_get, file);
        newXS("BerkeleyDB::Cursor::c_pget", XS_BerkeleyDB__Cursor_c_pget, file);
        newXS("BerkeleyDB::Cursor::c_put", XS_BerkeleyDB__Cursor_c_put, file);
        newXS("BerkeleyDB::Cursor::c_count", XS_BerkeleyDB__Cursor_c_count, file);
        newXS("BerkeleyDB::TxnMgr::_txn_begin", XS_BerkeleyDB__TxnMgr__txn_begin, file);
        newXS("BerkeleyDB::TxnMgr::status", XS_BerkeleyDB__TxnMgr_status, file);
        newXS("BerkeleyDB::TxnMgr::_DESTROY", XS_BerkeleyDB__TxnMgr__DESTROY, file);
        newXS("BerkeleyDB::TxnMgr::txn_close", XS_BerkeleyDB__TxnMgr_txn_close, file);
        newXS("BerkeleyDB::TxnMgr::txn_checkpoint", XS_BerkeleyDB__TxnMgr_txn_checkpoint, file);
        newXS("BerkeleyDB::TxnMgr::txn_stat", XS_BerkeleyDB__TxnMgr_txn_stat, file);
        newXS("BerkeleyDB::TxnMgr::txn_open", XS_BerkeleyDB__TxnMgr_txn_open, file);
        newXS("BerkeleyDB::Txn::status", XS_BerkeleyDB__Txn_status, file);
        newXS("BerkeleyDB::Txn::set_timeout", XS_BerkeleyDB__Txn_set_timeout, file);
        newXS("BerkeleyDB::Txn::set_tx_max", XS_BerkeleyDB__Txn_set_tx_max, file);
        newXS("BerkeleyDB::Txn::get_tx_max", XS_BerkeleyDB__Txn_get_tx_max, file);
        newXS("BerkeleyDB::Txn::_DESTROY", XS_BerkeleyDB__Txn__DESTROY, file);
        newXS("BerkeleyDB::Txn::txn_unlink", XS_BerkeleyDB__Txn_txn_unlink, file);
        newXS("BerkeleyDB::Txn::txn_prepare", XS_BerkeleyDB__Txn_txn_prepare, file);
        newXS("BerkeleyDB::Txn::_txn_commit", XS_BerkeleyDB__Txn__txn_commit, file);
        newXS("BerkeleyDB::Txn::_txn_abort", XS_BerkeleyDB__Txn__txn_abort, file);
        newXS("BerkeleyDB::Txn::_txn_discard", XS_BerkeleyDB__Txn__txn_discard, file);
        newXS("BerkeleyDB::Txn::txn_id", XS_BerkeleyDB__Txn_txn_id, file);
        newXS("BerkeleyDB::_tiedHash::FIRSTKEY", XS_BerkeleyDB___tiedHash_FIRSTKEY, file);
        newXS("BerkeleyDB::_tiedHash::NEXTKEY", XS_BerkeleyDB___tiedHash_NEXTKEY, file);
        newXS("BerkeleyDB::Recno::FETCHSIZE", XS_BerkeleyDB__Recno_FETCHSIZE, file);
        newXS("BerkeleyDB::Queue::FETCHSIZE", XS_BerkeleyDB__Queue_FETCHSIZE, file);
        newXS("BerkeleyDB::Common::db_create_sequence", XS_BerkeleyDB__Common_db_create_sequence, file);
        newXS("BerkeleyDB::Sequence::open", XS_BerkeleyDB__Sequence_open, file);
        newXS("BerkeleyDB::Sequence::close", XS_BerkeleyDB__Sequence_close, file);
        newXS("BerkeleyDB::Sequence::remove", XS_BerkeleyDB__Sequence_remove, file);
        newXS("BerkeleyDB::Sequence::DESTROY", XS_BerkeleyDB__Sequence_DESTROY, file);
        newXS("BerkeleyDB::Sequence::get", XS_BerkeleyDB__Sequence_get, file);
        newXS("BerkeleyDB::Sequence::get_key", XS_BerkeleyDB__Sequence_get_key, file);
        newXS("BerkeleyDB::Sequence::initial_value", XS_BerkeleyDB__Sequence_initial_value, file);
        newXS("BerkeleyDB::Sequence::set_cachesize", XS_BerkeleyDB__Sequence_set_cachesize, file);
        newXS("BerkeleyDB::Sequence::get_cachesize", XS_BerkeleyDB__Sequence_get_cachesize, file);
        newXS("BerkeleyDB::Sequence::set_flags", XS_BerkeleyDB__Sequence_set_flags, file);
        newXS("BerkeleyDB::Sequence::get_flags", XS_BerkeleyDB__Sequence_get_flags, file);
        newXS("BerkeleyDB::Sequence::set_range", XS_BerkeleyDB__Sequence_set_range, file);
        newXS("BerkeleyDB::Sequence::stat", XS_BerkeleyDB__Sequence_stat, file);
    }
