...
if($input eq "acit")
{
		$fname = "../release/2008/networks/author-citation-network.txt";
}

elsif ($input eq "acoll")
{
		$fname = "../release/2008/networks/author-collaboration-network.txt";
}

else
{
		$fname = "../release/2008/acl.txt";
}
